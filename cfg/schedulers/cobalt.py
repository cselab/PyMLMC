...
submit = 'qsub --project CloudPredict --nodecount %(nodes)d --time %(hours).2d:%(minutes).2d:00 --outputprefix %(reportfile)s --jobname %(label)s --notify %(email)s --disable_preboot %(xopts)s --mode script %(scriptfile)s'
