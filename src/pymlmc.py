...
class MLMC (object):
  ...
  def __init__ (self, config):
    ...
    # indicators
    self.indicators = Indicators ( self.config.solver.indicator, self.config.solver.distance, self.config.levels, self.config.levels_types, self.config.pick, self.config.FINE, self.config.COARSE, self.config.works, self.config.samples.pairworks, self.config.recycle )
